    ...
    <div className='a'>
        <div className="a-left">
            ...
            <div className="a-card">
                ...
                <img src="https://builtin.com/sites/www.builtin.com/files/styles/og/public/2022-09/fintech.png" alt="developer"                 
                className="a-img" />
            </div>
        </div>
        <div className="a-right">
            ...
            <p className="a-sub">
                ...
                Lead project is <a className='a-saver' href="https://esaver.netlify.app/">eSaver</a> - a work-in-progress which will be a convenient daily-savings app. 
            </p>
            <p className="a-desc">
